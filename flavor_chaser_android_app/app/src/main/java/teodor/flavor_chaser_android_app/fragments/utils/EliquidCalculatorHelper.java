...
public class EliquidCalculatorHelper {
    ...
    public static ArrayList<RecipeIngredientResult> getRecipeIngredientsResults(Double baseVgPercentage,
        ...
        RecipeIngredientResult nicotineRecipeIngredientResult = getNicotineRecipeResult(nicshotVgPercentage, nicshotPgPercentage, totalFinalAmount, finalNicotineStrength, nicshotStrengthInMg);
        ...
        for (Map.Entry<String, Double> entry : flavorsPercentagesMap.entrySet()) {
            flavorsRecipeIngredientsResults.add(getFlavorRecipeResult(entry.getKey(), entry.getValue(), totalFinalAmount));
        ...
        if (withIndividualPgVg) {
            recipeIngredientsResults.add(getVgRecipeResult(baseVgPercentage, nicshotVgPercentage, totalFinalAmount, allFlavorsMilliliters, nicotineRecipeIngredientResult.getMilliliters()));
            recipeIngredientsResults.add(getPgRecipeResult(basePgPercentage, nicshotPgPercentage, totalFinalAmount, allFlavorsMilliliters, nicotineRecipeIngredientResult.getMilliliters()));
        } else {
            recipeIngredientsResults.add(getBaseRecipeResult(baseVgPercentage, basePgPercentage, totalFinalAmount, allFlavorsMilliliters, nicotineRecipeIngredientResult.getMilliliters()));
        }
    ...
    private static RecipeIngredientResult getVgRecipeResult(Double desiredFinalVgPercentage, Double nicshotVgPercentage, Double totalFinalAmount, Double allFlavorsMilliliters, Double nicotineMililiters) {
    ...
    private static RecipeIngredientResult getPgRecipeResult(Double desiredFinalPgPercentage, Double nicshotPgPercentage, Double totalFinalAmount, Double allFlavorsMilliliters, Double nicotineMililiters) {
    ...
    private static RecipeIngredientResult getBaseRecipeResult(Double baseVgPercentage, Double basePgPercentage, Double totalFinalAmount, Double allFlavorsMilliliters, Double nicotineMililiters) {
    ...
    private static RecipeIngredientResult getNicotineRecipeResult(Double nicshotVgPercentage, Double nicshotPgPercentage, Double totalFinalAmount, Double finalNicotineStrength, Double nicshotStrengthInMg) {
    ...
    private static RecipeIngredientResult getFlavorRecipeResult(String flavorName, Double flavorPercentage, Double totalFinalAmount) {
